/******/ (() => {
								...
								if (!swiper.params.pagination.renderBullet) {
									...
									addElLabel(
										...
										params.paginationBulletMessage.replace(
											/\{\{index\}\}/,
											(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.h)(
												bulletEl,
											) + 1,
										),
									);
					...
					function setTransition(duration, byController) {
						...
						function setControlledTransition(c) {
							...
							if (duration !== 0) {
								...
								(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.k)(
									c.wrapperEl,
									() => {
			...
			/***/ (
				...
				function EffectCoverflow(_ref) {
					...
					const setTranslate = () => {
						...
						const r = (0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_3__.o)(
							swiper,
						);
			...
			/***/ (
				...
				function EffectCreative(_ref) {
					...
					const setTranslate = () => {
						...
						const rotateFix = (0,
						_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_4__.o)(swiper);
						if (isCenteredSlides) {
							const margin =
			...
			/***/ (
				...
				function EffectCube(_ref) {
					...
					const setTranslate = () => {
						...
						const r = (0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.o)(
							swiper,
						);
					...
					function onTouchEnd(_ref2) {
						...
						if (params.freeMode.momentum) {
							if (data.velocities.length > 1) {
								...
								if (
									time > 150 ||
									(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.d)() -
										lastMoveEvent.time >
										300
								) {
									swiper.velocity = 0;
				...
				function Keyboard(_ref) {
					...
					function handle(event) {
						...
						if (
							...
							_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.b)(el);
			...
			/***/ (
				...
				function Pagination(_ref) {
					...
					function onBulletClick(e) {
						...
						e.preventDefault();
						const index =
							(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.h)(bulletEl) *
						...
						if (
							...
							if (el.length > 1) {
								bullets.forEach((bullet) => {
									const bulletIndex = (0,
									_shared_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.h)(bullet);
					...
					function init() {
						...
						if (
							...
							if (el.length > 1) {
								el = el.find((subEl) => {
									if (
										(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_2__.a)(
											subEl,
											".swiper",
										)[0] !== swiper.el
									)
					...
					function setDragPosition(e) {
						...
						positionRatio =
							(getPointerPosition(e) -
								(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.b)(el)[
									swiper.isHorizontal() ? "left" : "top"
								] -
				...
				function Thumb(_ref) {
					...
					function init() {
						...
						if (thumbsParams.swiper instanceof SwiperClass) {
							...
							(0, _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.l)(
								thumbsParams.swiper,
							)
						) {
  ...
  \****************************************************/
			/***/ (
				...
				function Observer(_ref) {
					...
					const init = () => {
						...
						if (swiper.params.observeParents) {
							...
							_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.a)(swiper.hostEl);
						...
						if (params.slidesPerView === "auto") {
							...
							if (params.roundLengths) {
								slideSize = swiper.isHorizontal()
									? (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__.f)(
											slide,
											"width",
											true,
									  )
				...
				function getSwiperTranslate(axis) {
					...
					let currentTranslate = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__.j)(
						wrapperEl,
						axis,
					);
    ...
    'watch-progress': params.watchSlidesProgress
					...
					constructor() {
						...
						if (
							...
							document.querySelectorAll(params.el).forEach((containerEl) => {
								const newParams = (0,
								_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.w)({}, params, {
									el: containerEl,
								});
						...
						const swiperParams = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__.w)(
							{},
							defaults,
							allModulesParams,
						);
						...
						swiper.params = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__.w)(
							{},
							swiperParams,
							extendedDefaults,
							params,
						...
						_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.w)({}, swiper.params);
      ...
      'marginRight': 'marginBottom'
					...
					getSlideIndex(slideEl) {
						...
						_utils_mjs__WEBPACK_IMPORTED_MODULE_1__.h)(slides[0]);
						return (
							(0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__.h)(slideEl) -
							firstSlideIndex
						);
					}
  ...
  \***************************************************************/
			/***/ (
				...
				/* harmony import */ var _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(
						/*! ./update-swiper.mjs */ "./node_modules/swiper/shared/update-swiper.mjs",
					);
				/* harmony import */ var _swiper_core_mjs__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./swiper-core.mjs */ "./node_modules/swiper/shared/swiper-core.mjs",
					);
				...
				function getParams(obj, splitEvents) {
					...
					const events = {};
					const passedParams = {};
					(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(
						params,
						_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_1__.d,
					);
					params._emitClasses = true;
					params.init = false;
					const rest = {};
					const allowedParams =
						_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.p.map((key) =>
							key.replace(/_/, ""),
						);
					...
					Object.keys(plainObj).forEach((key) => {
						...
						if (allowedParams.indexOf(key) >= 0) {
							if (
								(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(obj[key])
							) {
								params[key] = {};
								passedParams[key] = {};
								(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(
				...
				function mountSwiper(_ref, swiperParams) {
					...
					if (
						(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.n)(
							swiperParams,
						) &&
						nextEl &&
						prevEl
					...
					if (
						(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.a)(
							swiperParams,
						) &&
						paginationEl
					) {
					...
					if (
						(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(
							swiperParams,
						) &&
						scrollbarEl
					) {
				...
				function getChangedParams(
					...
					const watchParams = _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.p
						.filter((key) => key[0] === "_")
						.map((key) => key.replace(/_/, ""));
					watchParams.forEach((key) => {
						if (key in swiperParams && key in oldParams) {
							if (
								(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(
									swiperParams[key],
								) &&
								(0, _update_swiper_mjs__WEBPACK_IMPORTED_MODULE_0__.i)(
									oldParams[key],
  ...
  \******************************************************/
			/***/ (
				...
				function needsPagination(params) {
					...
					return (
						params.pagination && typeof params.pagination.el === "undefined"
					);
				}
				...
				function attrToProp(attrName) {
					...
					return attrName.replace(/-[a-z]/g, (l) =>
				...
				function updateSwiper(_ref) {
					...
					if (
						...
						(!currentParams.thumbs.swiper ||
							currentParams.thumbs.swiper.destroyed)
					) {
						needThumbsInit = true;
					}
					if (
  ...
  \**********************************************/
			/***/ (
				...
				/* harmony export */ __webpack_require__.d(__webpack_exports__, {
					...
					/* harmony export */ useSwiperSlide: () =>
						/* binding */ useSwiperSlide,
					/* harmony export */
				});
				/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ =
					__webpack_require__(/*! react */ "react");
				/* harmony import */ var _shared_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./shared/swiper-core.mjs */ "./node_modules/swiper/shared/swiper-core.mjs",
					);
				/* harmony import */ var _shared_update_on_virtual_data_mjs__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./shared/update-on-virtual-data.mjs */ "./node_modules/swiper/shared/update-on-virtual-data.mjs",
					);
				/* harmony import */ var _shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ./shared/update-swiper.mjs */ "./node_modules/swiper/shared/update-swiper.mjs",
					);
				/**
				 * Swiper React 11.2.6
				...
				function processChildren(c) {
					const slides = [];
					react__WEBPACK_IMPORTED_MODULE_0__.Children.toArray(c).forEach(
						(child) => {
				...
				const SwiperSlideContext = /*#__PURE__*/ (0,
				...
				const SwiperContext = /*#__PURE__*/ (0,
				react__WEBPACK_IMPORTED_MODULE_0__.createContext)(null);
				const useSwiper = () => {
					return (0, react__WEBPACK_IMPORTED_MODULE_0__.useContext)(
						SwiperContext,
				...
				const Swiper = /*#__PURE__*/ (0,
				react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
					function (_temp, externalElRef) {
						let {
							className,
							tag: Tag = "div",
						...
						const [containerClasses, setContainerClasses] = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useState)("swiper");
						const [virtualData, setVirtualData] = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useState)(null);
						const [breakpointChanged, setBreakpointChanged] = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
						const initializedRef = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useRef)(false);
						const swiperElRef = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
							null,
						);
						const swiperRef = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
							null,
						);
						const oldPassedParamsRef = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
						const oldSlides = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
							null,
						);
						const nextElRef = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
							null,
						);
						const prevElRef = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
							null,
						);
						const paginationElRef = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
						const scrollbarElRef = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
						const {
							params: swiperParams,
							passedParams,
						...
						_shared_update_on_virtual_data_mjs__WEBPACK_IMPORTED_MODULE_2__.g)(
							rest,
						);
						...
						const initSwiper = () => {
							...
							swiperRef.current =
								new _shared_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_1__.S(
									passParams,
								);
							if (
								...
								(0, _shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.e)(
									swiperRef.current.params.virtual,
									extendWith,
								);
								(0, _shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.e)(
									swiperRef.current.originalParams.virtual,
									extendWith,
								);
							}
						};
						...
						useIsomorphicLayoutEffect(() => {
							...
							(0,
							_shared_update_on_virtual_data_mjs__WEBPACK_IMPORTED_MODULE_2__.m)(
								{
						...
						useIsomorphicLayoutEffect(() => {
							attachEvents();
							const changedParams = (0,
							_shared_update_on_virtual_data_mjs__WEBPACK_IMPORTED_MODULE_2__.a)(
								passedParams,
						...
						useIsomorphicLayoutEffect(() => {
							(0,
							_shared_update_on_virtual_data_mjs__WEBPACK_IMPORTED_MODULE_2__.u)(
								swiperRef.current,
							);
						}, [virtualData]);
						...
						return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
							...
							_extends(
								{
									ref: swiperElRef,
									className: (0,
									_shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.d)(
							...
							/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
								...
								/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
									...
									{
										className: (0,
										_shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.w)(
								...
								(0, _shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
									swiperParams,
								) &&
									/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
								...
								(0, _shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.b)(
									swiperParams,
								) &&
									/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
										"div",
								...
								(0, _shared_update_swiper_mjs__WEBPACK_IMPORTED_MODULE_3__.a)(
									swiperParams,
								) &&
									/*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
										"div",
				...
				const SwiperSlide = /*#__PURE__*/ (0,
				react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(
					function (_temp, externalRef) {
						let {
							tag: Tag = "div",
							children,
							className = "",
						...
						const slideElRef = (0, react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
							null,
						);
						const [slideClasses, setSlideClasses] = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useState)("swiper-slide");
						const [lazyLoaded, setLazyLoaded] = (0,
						react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  ...
  \****************************************/
		...
		/***/ "./src/customhero/block.json":
			/*!***********************************!*\
  !*** ./src/customhero/block.json ***!
  \***********************************/
			/***/ (module) => {
				module.exports = /*#__PURE__*/ JSON.parse(
					'{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"myblocks/customhero","version":"0.1.0","title":"Custom Hero","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"attributes":{"autoplay":{"type":"boolean","default":true},"slides":{"type":"array","default":[{"title":"","subtitle":"","backgroundImage":""}]},"icons":{"type":"array","default":[{"icon":"","title":"Icona 1","url":""},{"icon":"","title":"Icona 2","url":""},{"icon":"","title":"Icona 3","url":""}]}},"textdomain":"customhero","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScript":"file:./view.js"}',
				);

				/***/
			},

		/***/ "./src/customhero/edit.js":
			/*!********************************!*\
  !*** ./src/customhero/edit.js ***!
  \********************************/
			/***/ (
				...
				/* harmony import */ var _editor_scss__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./editor.scss */ "./src/customhero/editor.scss",
					);
				...
				/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_6__ =
					__webpack_require__(
						/*! swiper/modules */ "./node_modules/swiper/modules/index.mjs",
					);
				/* harmony import */ var swiper_css__WEBPACK_IMPORTED_MODULE_7__ =
					__webpack_require__(
						/*! swiper/css */ "./node_modules/swiper/swiper.css",
					);
				/* harmony import */ var swiper_css_navigation__WEBPACK_IMPORTED_MODULE_8__ =
					__webpack_require__(
						/*! swiper/css/navigation */ "./node_modules/swiper/modules/navigation.css",
					);
				/* harmony import */ var swiper_css_pagination__WEBPACK_IMPORTED_MODULE_9__ =
					__webpack_require__(
				...
				/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10___default =
					/*#__PURE__*/ __webpack_require__.n(
																										...
																										react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(
																											"div",
																											{
																												...
																												children:
																													/*#__PURE__*/ (0,
																													react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(
																														_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.URLInputButton,
																														{
  ...
  \*********************************/
			/***/ (
				...
				/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./style.scss */ "./src/customhero/style.scss",
					);
				/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(/*! ./edit */ "./src/customhero/edit.js");
				/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ =
					__webpack_require__(
						/*! ./block.json */ "./src/customhero/block.json",
					);
				/**
  ...
  \**********************************/
	...
	/******/ (() => {
		...
		/******/
		/******/ var chunkLoadingGlobal = (globalThis["webpackChunkcustomhero"] =
			globalThis["webpackChunkcustomhero"] || []);
	...
	/******/ var __webpack_exports__ = __webpack_require__.O(
		undefined,
		["customhero/style-index"],
		() => __webpack_require__("./src/customhero/index.js"),
	);
